...
let roomUserInfoList: string = "[{\"userId\":4024796,\"userID\":4024796,\"userProfile\":\"玩家kBMoZrom进入了房间, {\"modelID\":1,\"userName\":\"玩家kBMoZrom\"}\"}]";

let userProfile = "玩家kBMoZrom进入了房间, {\"modelID\":1,\"userName\":\"玩家kBMoZrom\"}";
...
let matchReg = /{.*}/;
let ret = userProfile.match(matchReg);
console.log(ret);

if (ret)
{
    let obj = JSON.parse(ret[0]);
    console.log("obj:" + JSON.stringify(obj));    
}


let ret2 = userProfile.replace(matchReg, "$1");
console.log(ret2);
